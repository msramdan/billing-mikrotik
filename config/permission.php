...
return [
  ...
  ['group' => 'pemasukans', 'access' => ['pemasukan view', 'pemasukan create', 'pemasukan edit', 'pemasukan delete']],['group' => 'pengeluarans', 'access' => ['pengeluaran view', 'pengeluaran create', 'pengeluaran edit', 'pengeluaran delete']], 
		],];