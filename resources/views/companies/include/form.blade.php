<div class="row mb-2">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" name="no_wa" id="no-wa"
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <textarea name="alamat" id="alamat" class="form-control @error('alamat') is-invalid @enderror"
                placeholder="{{ __('Alamat') }}">{{ isset($company) ? $company->alamat : old('alamat') }}</textarea>
            @error('alamat')
                <span class="text-danger">
                    {{ $message }}
                </span>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <textarea name="deskripsi_perusahaan" id="deskripsi-perusahaan"
                ...
                placeholder="{{ __('Deskripsi Perusahaan') }}">{{ isset($company) ? $company->deskripsi_perusahaan : old('deskripsi_perusahaan') }}</textarea>
                ...
                <div class="col-md-4 text-center">
                    ...
                    @else
                        <img src="{{ asset('storage/uploads/logos/' . $company->logo) }}" alt="Logo"
                            class="rounded mb-2 mt-2" width="150" height="150" style="object-fit: cover">
                    @endif
                </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="url" name="url_wa_gateway" id="url-wa-gateway"
                class="form-control @error('url_wa_gateway') is-invalid @enderror"
                value="{{ isset($company) ? $company->url_wa_gateway : old('url_wa_gateway') }}"
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" name="api_key_wa_gateway" id="api-key-wa-gateway"
                ...
                value="{{ isset($company) ? $company->api_key_wa_gateway : old('api_key_wa_gateway') }}"
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <select class="form-select @error('is_active') is-invalid @enderror" name="is_active" id="is-active"
                ...
                <option value="Yes"
                    {{ isset($company) && $company->is_active == 'Yes' ? 'selected' : (old('is_active') == 'Yes' ? 'selected' : '') }}>
                    Yes</option>
                <option value="No"
                    {{ isset($company) && $company->is_active == 'No' ? 'selected' : (old('is_active') == 'No' ? 'selected' : '') }}>
                    No</option>
            </select>
            @error('is_active')
                <span class="text-danger">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <textarea name="footer_pesan_wa_tagihan" id="footer-pesan-wa-tagihan"
                class="form-control @error('footer_pesan_wa_tagihan') is-invalid @enderror"
                placeholder="{{ __('Footer Pesan Wa Tagihan') }}">{{ isset($company) ? $company->footer_pesan_wa_tagihan : old('footer_pesan_wa_tagihan') }}</textarea>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <textarea name="footer_pesan_wa_pembayaran" id="footer-pesan-wa-pembayaran"
                class="form-control @error('footer_pesan_wa_pembayaran') is-invalid @enderror"
                placeholder="{{ __('Footer Pesan Wa Pembayaran') }}">{{ isset($company) ? $company->footer_pesan_wa_pembayaran : old('footer_pesan_wa_pembayaran') }}</textarea>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" name="url_tripay" id="url-tripay"
                ...
                value="{{ isset($company) ? $company->url_tripay : old('url_tripay') }}"
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" name="api_key_tripay" id="api-key-tripay"
                ...
                value="{{ isset($company) ? $company->api_key_tripay : old('api_key_tripay') }}"
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" name="kode_merchant" id="kode-merchant"
                ...
                value="{{ isset($company) ? $company->kode_merchant : old('kode_merchant') }}"
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" name="private_key" id="private-key"
                ...
                value="{{ isset($company) ? $company->private_key : old('private_key') }}"
    ...
    @can('company create')
        <div class="col-md-6">
            <div class="form-group">
                ...
                <select class="form-select @error('paket_id') is-invalid @enderror" name="paket_id" id="paket-id"
                    class="form-control" required>
                    <option value="" selected disabled>-- {{ __('Select paket') }} --</option>

                    @foreach ($pakets as $paket)
                        <option value="{{ $paket->id }}"
                            {{ isset($company) && $company->paket_id == $paket->id ? 'selected' : (old('paket_id') == $paket->id ? 'selected' : '') }}>
                            {{ $paket->nama_paket }}
                        </option>
                    @endforeach
                </select>
