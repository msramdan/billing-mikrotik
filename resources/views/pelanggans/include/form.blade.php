            ...
            <div class="row">
                <div class="col-md-5 text-center">
                    @if ($pelanggan->photo_ktp == null)
                        <img src="https://via.placeholder.com/350?text=No+Image+Avaiable" alt="Photo Ktp" class="rounded mb-2 mt-2" alt="Photo Ktp" width="100%" height="150" style="object-fit: cover">
                    @else
