                        ...
                        <div class="col-lg-7 col-md-7">
                            <div class="top-header-right">
                                <div class="login-signup-btn">
                                    <p><a href="{{ route('loginClient') }}">Login</a> <span>or</span> <a href="{{ route('registerClient') }}">Register</a></p>
                                </div>
                        ...
                        <nav class="navbar navbar-expand-md navbar-light">
                            ...
                            <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item"><a href="{{ route('cekTagihan') }}" class="nav-link">Cek Tagihan</a></li>
                                    <li class="nav-item"><a href="{{ route('areaCoverage') }}" class="nav-link">Area Coverage</a></li>
                                    <li class="nav-item"><a href="{{ route('speedTest') }}" class="nav-link">Speed Test</a></li>
                                </ul>
                            </div>
                        </nav>
                    </div>
