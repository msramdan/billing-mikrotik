...
class Odp extends Model
{
     ...
     * @var string[]
     */
    protected $fillable = ['kode_odc','company_id', 'nomor_port_odc', 'kode_odp', 'wilayah_odp', 'warna_tube_fo', 'nomor_tiang', 'jumlah_port', 'document', 'description', 'latitude', 'longitude'];
